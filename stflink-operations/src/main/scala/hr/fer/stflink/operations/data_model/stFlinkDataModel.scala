...
import hr.fer.stflink.operations.common.GeoLifeTuple

object stFlinkDataModel {
...
//            println("R br: " + Integer.toString(i) + " | Driver: " + line.id + " | Geometry: "+ g + " | Point:" + line.position +" | Timestamp: " + line.timestamp.toString())
        	...
        	var upoint: PointUnit = stFlinkDataModel.createUpoint(intimeObject1, intimeObject2)
