...
object Helpers {
  ...
  def createAreaOfInterest : Polygon = {
    ...
    var coordinate1 = stFlinkDataModel.latlonToUTM(lat1, lon1)
    var coordinate2 = stFlinkDataModel.latlonToUTM(lat1, lon2)
    var coordinate3 = stFlinkDataModel.latlonToUTM(lat2, lon1)
    var coordinate4 = stFlinkDataModel.latlonToUTM(lat2, lon2)
